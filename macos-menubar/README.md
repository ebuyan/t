...
полная стоимость, изменение в ₽ и %, доход за всё время (курсовой плюс полученные
выплаты), классы Акции / Золото / Недвижимость / Кеш с отдельной строкой суммарных
дивидендов и время последнего обновления. Пункты Акции, Золото и Недвижимость
раскрываются подменю с бумагами класса и их изменением за сегодня. Недвижимость
появляется, только когда сервис отдаёт поле `realty`, то есть после деплоя стенда.
